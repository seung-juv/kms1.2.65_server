...
/*
 * NPCID : 1012105
 * ScriptName : skin_henesys1
 * NPCNameFunc : 나미녀 - 피부관리사
 * Location : 100000105 (빅토리아로드 - 헤네시스피부관리실)
 * 
 * @author T-Sun
 *
 */
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	cm.sendNext("아름다운 피부로 가꾸시고 싶으신가요? 제가 도와드리도록 하지요. 서비스를 이용하려면 #b#t5153000##k 아이템을 가져오셔야 합니다.");
    } else if (status == 1) {
