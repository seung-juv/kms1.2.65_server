...
var rCost = Array(1200, 1000, 1000, 800, 1200);
var costBeginner = Array(120, 100, 100, 80, 120);
var cost = new Array("1,200", "1,000", "1,000", "800", "1,200");
var show;
var sCost;
var selectedMap = -1;
...
function action(mode, type, selection) {
	...
	if (job == 0 || job == 1000 || job == 2000) {
	    var selStr = "저희 택시는 초보자 분들에게 90% 할인한 요금을 받습니다. 목적지를 선택해주세요.#b";
