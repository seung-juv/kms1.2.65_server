...
/*
 * NPCID : 1072006
 * ScriptName : inside_archer
 * NPCNameFunc : 궁수 전직교관
 * Location : 108000101 (히든스트리트 - 궁수의개미굴)
 * Location : 108000100 (히든스트리트 - 궁수의개미굴)
 * Location : 108000102 (히든스트리트 - 궁수의개미굴)
 * 
 * @author T-Sun
 *
 */
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        if (cm.haveItem(4031013, 30)) {
            cm.sendNext("호오, 대단하군. 이렇게나 많은 검은 구슬을 모아올 줄이야. 좋네. 자네를 인정해주겠네. 이것을 갖고 헬레나님께 돌아가 보게나.")
        } else {
