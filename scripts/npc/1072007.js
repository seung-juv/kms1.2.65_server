...
/*
 * NPCID : 1072007
 * ScriptName : inside_rogue
 * NPCNameFunc : 도적 전직교관
 * Location : 108000401 (히든스트리트 - 도적의공사장)
 * Location : 108000400 (히든스트리트 - 도적의공사장)
 * Location : 108000402 (히든스트리트 - 도적의공사장)
 * 
 * @author T-Sun
 *
 */
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        if (cm.haveItem(4031013, 30)) {
            cm.sendNext("호오, 대단하군. 이렇게나 많은 검은 구슬을 모아올 줄이야. 좋네. 자네를 인정해주겠네. 이것을 갖고 다크로드님께 돌아가 보게나.")
        } else {
