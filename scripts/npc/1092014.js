...
var rCost = Array(1000, 1200, 800, 1200, 800);
var costBeginner = Array(100, 120, 80, 120, 80);
var cost = new Array("1,000", "1,200", "800", "1,200", "800");
var show;
var sCost;
var selectedMap = -1;
...
function action(mode, type, selection) {
	...
	status--;
    if (status == 0) {
	cm.sendNext("안녕하세요~! 노틸러스 중형택시입니다. 다른 마을로 안전하고 빠르게 이동하고 싶으신가요? 그렇다면 저희 택시를 이용해 보세요. 싼 가격으로 원하시는 곳까지 친절하게 모셔다 드리고 있습니다.");
    } else if (status == 1) {
	var job = cm.getJob();
