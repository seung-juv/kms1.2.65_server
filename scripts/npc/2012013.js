 ...
 * NPCNameFunc : 서나 - 매표소 안내원
 * Location : 200000121 (오르비스 - 정거장<루디브리엄행>)
 * 
 * @author T-Sun
 *
 */
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if(boat == null) {
            ...
            cm.sendOk("아직 배가 출항 준비중에 있습니다. 배는 매 시간 정각 기준 10, 20, 30, 40, 50분에 출항을 준비하며, 최장 30분 이내에 출항 준비가 완료됩니다.");
            cm.dispose();
            ...
            cm.sendOk("이미 배가 루디브리엄으로 출발했답니다. 배는 매 시간 기준으로 10분 마다 출발하니 잠시만 기다려 보세요.");
            cm.dispose();
        }
    } else if (status == 2) {
