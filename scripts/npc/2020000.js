...
/*
 * NPCID : 2020000
 * ScriptName : refine_elnath
 * NPCNameFunc : 보겐 - 제련 전문가
...
function action(mode, type, selection) {
    if (mode == 1)
        ...
        cm.dispose();
    if (status == 0 && mode == 1) {
        var selStr = "흠? 무얼 하러 온겐가? 아, 내 뛰어난 제련 솜씨를 듣고 찾아온거로구만? 그렇다면 실력발휘를 한번 해보도록 하지. 자. 원하는게 뭔가?#b"
        ...
        if (selectedType == 0){ //mineral refine
            var selStr = "어떤 종류의 광석을 제련하고 싶나?#b";
            ...
            var selStr = "어떤 종류의 보석을 제련하고 싶나?#b";
            ...
            var selStr = "희귀 보석이라.. 어떤걸 생각하고 있나?#b";
            ...
            var selStr = "크리스탈 제련..? 흐음.. 구하기 어려웠을텐데.. 무슨 크리스탈 원석을 가져왔는가?#b";
            ...
            var selStr = "자네에게 몇가지 재료를 만들어 줄 수 있다네.#b";
            ...
            var selStr = "화살? 흐음. 이 몸을 뭘로 보고. 당연히 문제 없다네.#b";
        ...
        if (selectedType == 0){ //mineral refine
            ...
            var costSet = new Array (5000,5000,5000,5000,100000);
            item = itemSet[selectedItem];
            mats = matSet[selectedItem];
            matQty = matQtySet[selectedItem];
            cost = costSet[selectedItem];
        ...
        var prompt = "#t" + item + "# 아이템을 만들어 보고 싶은건가? 몇개를 만들어 보고 싶은가?";
        ...
        prompt += " 그렇다면 다음과 같은 재료를 구해와야 하네. 그리고 인벤토리 공간도 충분한지 확인해 보게나.\r\n#b";
