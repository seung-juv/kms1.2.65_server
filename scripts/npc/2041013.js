...
/*
 * NPCID : 2041013
 * ScriptName : skin_ludi1
 * NPCNameFunc : 지나 - 피부관리사
 * Location : 220000005 (루디브리엄 - 루디브리엄피부관리실)
 * 
 * @author T-Sun
 *
 */
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	cm.sendNext("아름다운 피부로 가꾸시고 싶으신가요? 제가 도와드리도록 하지요. 서비스를 이용하려면 #b#t5153002##k 아이템을 가져오셔야 합니다.");
    } else if (status == 1) {
