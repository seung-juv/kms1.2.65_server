...
public class MapleKeyLayout implements Serializable {
    ...
    public final void writeData(final MaplePacketLittleEndianWriter mplew) {
        ...
        if (keymap.isEmpty()) {
            ...
            keymap.put(Integer.valueOf(42), new Pair<Byte, Integer>((byte) 4, 0x15));
            ...
            keymap.put(Integer.valueOf(57), new Pair<Byte, Integer>((byte) 5, 0x36));
            keymap.put(Integer.valueOf(59), new Pair<Byte, Integer>((byte) 6, 100));
