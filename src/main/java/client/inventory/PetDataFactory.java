...
public class PetDataFactory {
    ...
    private static final MapleDataProvider dataRoot = MapleDataProviderFactory.getDataProvider(new File(ServerProperties.getProperty("server.wz-path") + "/Item.wz"));
    private static final Map<Integer, List<PetCommand>> petCommands = new HashMap<Integer, List<PetCommand>>();
