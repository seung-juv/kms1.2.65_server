...
public class ChannelServer {
    ...
    private static final short DEFAULT_PORT = 750;
    ...
    public final void run_startup_configurations() throws Exception {
        ...
        try {
            expRate = Integer.parseInt(ServerProperties.getProperty("channel.exp"));
            mesoRate = Integer.parseInt(ServerProperties.getProperty("channel.meso"));
            dropRate = Integer.parseInt(ServerProperties.getProperty("channel.drop"));
            serverName = ServerProperties.getProperty("server.name");
            serverMessage = ServerProperties.getProperty("server.message");
            flags = Integer.parseInt(ServerProperties.getProperty("channel.flags", "0"));
    ...
    public final String getRealChannelName() {
        return String.valueOf(channel == 1 ? "1" : channel == 2 ? "20세이상" : channel - 1);
    }
