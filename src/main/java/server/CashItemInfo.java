...
public class CashItemInfo {
    ...
    public static class CashModInfo {
        ...
        public CashModInfo(int sn, int discount, int mark, boolean show, int itemid, int priority, boolean packagez, int period, int gender, int count, int meso, int unk_1, int forpc, int unk_3, int extra_flags) {
            this.sn = sn;
            this.itemid = itemid;
