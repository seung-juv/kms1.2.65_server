...
public class MapleItemInformationProvider {
    ...
    protected final MapleDataProvider chrData = MapleDataProviderFactory.getDataProvider(new File(ServerProperties.getProperty("server.wz-path") + "/Character.wz"));
    protected final MapleDataProvider etcData = MapleDataProviderFactory.getDataProvider(new File(ServerProperties.getProperty("server.wz-path") + "/Etc.wz"));
    protected final MapleDataProvider itemData = MapleDataProviderFactory.getDataProvider(new File(ServerProperties.getProperty("server.wz-path") + "/Item.wz"));
    ...
    protected final MapleDataProvider stringData = MapleDataProviderFactory.getDataProvider(new File(ServerProperties.getProperty("server.wz-path") + "/String.wz"));
    ...
    public void runEtc() {
        ...
        for (MapleDataEntry b : a.getFiles()) {
            ...
            for (Entry<String, Pair<Point, Point>> ez : dummy.entrySet()) {
                if (ez.getKey().length() > 2 && ez.getKey().charAt(ez.getKey().length() - 2) == 'D') { //D = double weapon
