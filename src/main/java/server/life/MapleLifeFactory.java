...
public class MapleLifeFactory {
    ...
    private static final MapleDataProvider data = MapleDataProviderFactory.getDataProvider(new File(ServerProperties.getProperty("server.wz-path") + "/Mob.wz"));
    private static final MapleDataProvider npcData = MapleDataProviderFactory.getDataProvider(new File(ServerProperties.getProperty("server.wz-path") + "/Npc.wz"));
    private static final MapleDataProvider stringDataWZ = MapleDataProviderFactory.getDataProvider(new File(ServerProperties.getProperty("server.wz-path") + "/String.wz"));
    private static final MapleDataProvider etcDataWZ = MapleDataProviderFactory.getDataProvider(new File(ServerProperties.getProperty("server.wz-path") + "/Etc.wz"));
    ...
    public static MapleMonsterStats getMonsterStats(int mid) {
        ...
        if (stats == null) {
            ...
            /* 몬스터옵션이런식으로추가
          if (mid >= 8210000 && mid <= 8210005) { // 성벽
                stats.setHp(stats.getHp() * 100);
                stats.setPad(stats.getPad() * 5);
                stats.setAcc(stats.getAcc() * 10);
                stats.setEva((short) (stats.getEva() *5));
                stats.setMad(stats.getMad() * 5);
                stats.setPhysicalDefense((short) (stats.getPhysicalDefense() + 1000));
               stats.setMagicDefense((short) (stats.getMagicDefense() + 1000));
            }*/
