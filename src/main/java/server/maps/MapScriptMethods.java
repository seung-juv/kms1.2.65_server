    ...
    public static void startScript_FirstUser(MapleClient c, String scriptName) {
        ...
        switch (onFirstUserEnter.fromString(scriptName)) {
            ...
            case StageMsg_crack: {
                switch (c.getPlayer().getMapId()) {
                    case 922010100:
                        c.getPlayer().getMap().startMapEffect("라츠를 모두 없애고 통행증을 모으세요!", 5120018);
                        break;
                    case 922010200:
                        c.getPlayer().getMap().startSimpleMapEffect("모든 통행증을 모아오세요!", 5120018);
                        break;
                    case 922010300:
                        c.getPlayer().getMap().startMapEffect("모든 몬스터를 없애고 통행증을 모으세요!", 5120018);
                        break;
                    case 922010400:
                        c.getPlayer().getMap().startMapEffect("각 방의 몬스터를 없애고 통행증을 모으세요!", 5120018);
                        break;
                    case 922010500:
                        c.getPlayer().getMap().startMapEffect("각 방의 통행증을 모으세요!", 5120018);
                        break;
                    case 922010600:
                        c.getPlayer().getMap().startMapEffect("올바른 길을 찾아 꼭대기로 올라가세요!", 5120018);
                        break;
                    case 922010700:
                        c.getPlayer().getMap().startMapEffect("롬바드를 물리치고 통행증을 모으세요!", 5120018);
                        break;
                    case 922010800:
                        c.getPlayer().getMap().startSimpleMapEffect("올바른 발판을 찾으세요!", 5120018);
                        break;
                    case 922010900:
                        c.getPlayer().getMap().startMapEffect("알리샤르를 물리치세요!", 5120018);
                        break;
                }
                break;
            }
            case StageMsg_together: {
                switch (c.getPlayer().getMapId()) {
                    case 103000800:
                        c.getPlayer().getMap().startMapEffect("문제를 해결하고 해답에 맞는 개수만큼 쿠폰을 모아오세요!", 5120017);
                        break;
                    case 103000801:
                        c.getPlayer().getMap().startMapEffect("줄에 매달리고, 올바른 줄을 찾으세요!", 5120017);
                        break;
                    case 103000802:
                        c.getPlayer().getMap().startMapEffect("발판위에 올라서서, 올바른 발판을 찾으세요!", 5120017);
                        break;
                    case 103000803:
                        c.getPlayer().getMap().startMapEffect("통 위에 올라서서, 올바른 통을 찾으세요!", 5120017);
                        break;
                    case 103000804:
                        c.getPlayer().getMap().startMapEffect("킹슬라임과 부하들을 물리치고 통행증을 모아오세요!", 5120017);
                        break;
                }
                break;
            }
            ...
            case party6weatherMsg: {
                switch (c.getPlayer().getMapId()) {
                    ...
                    case 930000200:
                        ...
                        break;
                    case 930000300:
                        c.getPlayer().getMap().startMapEffect("숲이 혼란스러워졌어! 나를 찾아줘 빨리!", 5120023);
                        break;
                    case 930000400:
